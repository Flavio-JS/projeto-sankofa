...
export const metadata: Metadata = {
  title: "Projeto Sankofa | Arte, Educação e Cultura Afro-Brasileira",
  description:
    "Desde 2015, o Projeto Sankofa promove ações artísticas, pedagógicas e de pesquisa em percussão e cultura afro-brasileira. Atuando no IFG-Inhumas, o projeto realiza espetáculos, oficinas e desenvolve grupos como Sankofa/2GP, Afro Samba, Duo e Ritmos e Danças.",
  keywords: [
    "Projeto Sankofa",
  ...
  openGraph: {
    title: "Projeto Sankofa | Cultura, Ritmo e Educação",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Projeto Sankofa - Cultura Afro-Brasileira e Educação Musical",
      },
    ],
    locale: "pt_BR",
    type: "website",
