      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div id="group-1" className="bg-[#2c0f00] rounded-lg overflow-hidden">
            ...
            />
            <div className="p-6">
              <h3 className="text-xl font-bold text-[#f37b00] mb-2">
                Grupo Percussivo
              </h3>
          ...
          <div id="group-2" className="bg-[#2c0f00] rounded-lg overflow-hidden">
            <Image
              className="w-full h-48 object-cover"
            ...
            <div className="p-6">
              ...
              <p className="text-[#fefefe]">Movimentos que contam histórias</p>
            </div>
          </div>
          <div id="group-3" className="bg-[#2c0f00] rounded-lg overflow-hidden">
            <Image
              className="w-full h-48 object-cover"
            ...
            <div className="p-6">
              ...
              <p className="text-[#fefefe]">Formação musical para juventude</p>
            </div>
          </div>
          <div id="group-4" className="bg-[#2c0f00] rounded-lg overflow-hidden">
            <Image
              className="w-full h-48 object-cover"
            ...
            <div className="p-6">
              ...
              <p className="text-[#fefefe]">Espetáculos e apresentações</p>
            </div>
          </div>
        </div>
      </div>
